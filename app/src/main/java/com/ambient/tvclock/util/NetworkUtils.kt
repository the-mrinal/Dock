...
object NetworkUtils {
     ...
     *
     * This UUID is generated once and stored in app-private preferences,
     * so it persists across app restarts (until app data is cleared).
     *
    ...
    private const val PREFS_NAME = "phairplay_network"
    private const val PREF_KEY_DEVICE_UUID = "device_uuid"
}
